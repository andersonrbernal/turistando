...
import 'change_phone_settings_page_widget.dart'
...
class ChangePhoneSettingsPageModel
    extends FlutterFlowModel<ChangePhoneSettingsPageWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // State field(s) for phone_edit widget.
  FocusNode? phoneEditFocusNode;
